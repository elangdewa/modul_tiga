...
<div class="list-group list-group-numbered mt-4">
    ...
    <h1>Tugas Bootstrap</h1> <div class="list-group list-group-numbered mt-4"> <a href="{{ url('/bootstrap') }}"
         class="list-group-item list-group-item-action"> Tugas Bootstrap </a> </div>
</div>
    </div>
